...
class AgeRelatedChangesOfGene:
    ...
    sample: str = Field(
        title="Sample", description="Tissue or cell type the measurement was performed"
    )
    modelOrganism: str = Field(title="Model organism")
    ...
    valueForMale: str = Field(
        title="Values in percentage increase or decrease of expression levels for males"
    )
    valueForFemale: str = Field(
        title="Values in percentage increase or decrease of expression levels for females"
    )
    valueForAll: str = Field(
        title="Values in percentage increase or decrease of expression levels for both groups"
    )
...
class GeneAssociatedWithLongevityEffects:
    ...
    allelicPolymorphism: str = Field(
        title="Allelic polymorphism",
        description="SNP id or another or another designation for gene polymorphism",
    )
    sex: str = Field(title="Biological sex")
    allelicVariant: str = Field(
        title="Allelic variant", description="Polymorphic gene variant associated with the trait"
    )
...
class Researches:
    ...
    interventionToGeneImprovesVitalProcesses: List[
        InterventionToGeneImprovesVitalProcesses
    ] = Field(title="Effect of modulation of gene activity on the age-related process")
    ...
    geneAssociatedWithProgeriaSyndromes: Optional[
        List[GeneAssociatedWithProgeriaSyndromes]
    ] = Field(title="Gene association with accelerated aging in humans")
